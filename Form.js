...
const mob = document.getElementById('password')
...
function checkInput() {
    ...
    if (emailValue === '') {
        showError(email, "Please fill out this fields!")
    }
    ...
    if (passwordValue === '') {
        showError(password, "Please fill out this fields!")
    }
    else {
    ...
    if (mobValue === '') {
        showError(mob, "Please fill out this fields!")
    }
